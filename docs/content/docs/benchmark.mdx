---
title: Benchmark
description: Understand the current local benchmark setup and sample results for @omsimos/pdf-to-images.
---
...
- In other words, `@omsimos/pdf-to-images` was `6.19x` faster on that sample.
